...
use App\Http\Controllers\Api\V1\Auth\LoginWithAdditionalPasswordController;
...
Route::prefix('auth')->group(function () {
    ...
    Route::post('/login/additional-password', LoginWithAdditionalPasswordController::class);
